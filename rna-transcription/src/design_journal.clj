...
;; `#(* %1 %2) `is the same as `(fn [value1 value2] (+ value1 value2)) `;; the syntax sugar is often use with `map`, `reduce`, `apply` functions as the function definition tends to be compact and of single use.
...
;; (to-rna dictionary-dna-rna dictionary-dna-rna "GTGAC")
